...
export default function ReceiptUpload({ onUploadSuccess, onDelete, currentImage, publicId }: ReceiptUploadProps) {
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setIsUploading(true);
    const toastId = toast.loading('AI is analyzing your receipt...');
    ...
    try {
      ...
      const receiptRecord = response.data;
      
      onUploadSuccess(receiptRecord);
      setPreview(receiptRecord.image_url);
      ...
      toast.error(`Scan Failed: ${serverError}`, { id: toastId });
      setPreview(null);
    } finally {
