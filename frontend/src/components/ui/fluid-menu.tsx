  ...
  return (
    <div className="relative w-[64px]" data-expanded={isExpanded}>
      ...
      <div className="relative">
        ...
        <div 
          className="relative w-16 h-16 bg-white dark:bg-gray-800 cursor-pointer rounded-full group will-change-transform z-50 shadow-xl border border-slate-200 dark:border-white/10 flex items-center justify-center"
        ...
        {childrenArray.slice(1).map((child, index) => (
          <div 
            key={index} 
            className="absolute top-0 left-0 w-16 h-16 bg-white dark:bg-gray-800 rounded-full shadow-xl border border-slate-200 dark:border-white/10 will-change-transform flex items-center justify-center"
            style={{
